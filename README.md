...
The best templates to use, so far as being filled out the fullest, are the ones for Jonah.  They will be what we start with in designing a tool to create a database of templates or individual ZIP files of required files.  These Jonah templates are located at:
